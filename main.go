...
func setupResponse(w *http.ResponseWriter, req *http.Request) {
	...
	(*w).Header().Set("Access-Control-Allow-Headers", "Origin, Expires, Pragma, Cache-Control, Accept, Content-Type, Content-Length, Accept-Encoding, X-CSRF-Token, Authorization,  X-Auth-Token, X-Requested-With, Access-Control-Allow-Headers")
}
